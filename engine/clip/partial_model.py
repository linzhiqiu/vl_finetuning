from .model import CLIP, ModifiedResNet, VisionTransformer, Transformer
import torch
...
def get_text_encoder(cfg, clip_model):
    # contains feature_extractor (does encode_text() from prompts) and partial_model (need to reverse the dim)
    return get_split_transformer(clip_model, cfg.TEXT_FEATURE.LAYER_IDX)
...
def get_image_encoder(cfg, clip_model):
    # contains feature_extractor and partial_model
