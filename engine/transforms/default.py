...
from engine.transforms.autoaugment import SVHNPolicy, CIFAR10Policy, ImageNetPolicy
from engine.transforms.randaugment import RandAugment, RandAugment2, RandAugmentFixMatch
...
def _build_transform_train(cfg, choices, target_size, normalize):
    ...
    if "center_crop" in choices:
        print("+ resize longer edge + center crop")
