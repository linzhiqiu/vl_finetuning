...
if EVAL_MODE == 'partial':
    #### Partial START
    EVAL_DIR = "./eval_learn_all_results_partial"
    ...
    FEATURE_DIR = None
elif EVAL_MODE == 'partial_2':
    #### Partial START
    EVAL_DIR = "./eval_learn_all_results_partial_2"
    ...
    FEATURE_DIR = f"/data2/zhiqiul/"

    DIR = "./features"
    from features import get_text_encoder_name, get_image_encoder_name
