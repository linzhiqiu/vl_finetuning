#!/bin/bash
# Running on trinity-2-9 (logit scale 4) but out of storage
# Then Running on trinity-2-5 (logit scale 4), then moving to /data3
# Running on trinity-0-23 (logit scale default), then moving to /data3
WORKERS=0
