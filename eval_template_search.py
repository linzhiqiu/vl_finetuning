...
# EVAL_MODE = "template_default"
# EVAL_MODE = "template_classname"
EVAL_MODE = "template_extra_default"
if EVAL_MODE == 'template_default':
    template_map_dict = {
        "imagenet": "single",
        "caltech101": "single",
        "dtd": "default",
        "eurosat": "default",
        "fgvc_aircraft": "default",
        "food101": "default",
        "oxford_flowers": "default",
        "oxford_pets": "default",
        "stanford_cars": "single",
        "sun397": "single",
        "ucf101": "default",
    }
    DATASETS = list(template_map_dict.keys())
    EVAL_DIR = "./template_default_results"
    ## first layer
    IMAGES = ["rn50_layer_0"]
...
elif EVAL_MODE == 'template_classname':
    template_map_dict = {
        "imagenet": "classname",
        "caltech101": "classname",
        "dtd": "classname",
        "eurosat": "classname",
        "fgvc_aircraft": "classname",
        "food101": "classname",
        "oxford_flowers": "classname",
        "oxford_pets": "classname",
        "stanford_cars": "classname",
        "sun397": "classname",
        "ucf101": "classname",
    }
    DATASETS = list(template_map_dict.keys())
    EVAL_DIR = "./template_classname_results"
    ## first layer
    IMAGES = ["rn50_layer_0"]
...
elif EVAL_MODE == 'template_extra_default':
    template_map_dict = {
        "imagenet": "extra_default",
        "caltech101": "extra_default",
        "dtd": "extra_default",
        "eurosat": "extra_default",
        "fgvc_aircraft": "extra_default",
        "food101": "extra_default",
        "oxford_flowers": "extra_default",
        "oxford_pets": "extra_default",
        "stanford_cars": "extra_default",
        "sun397": "extra_default",
        "ucf101": "extra_default",
    }
    DATASETS = list(template_map_dict.keys())
    EVAL_DIR = "./template_extra_default_results"
    ## first layer
    IMAGES = ["rn50_layer_0"]
                        ...
                        for architecture_idx, architecture in enumerate(ARCHITECTURES):
                            ...
                            for logit_idx, logit in enumerate(LOGITS):
                                ...
                                for hyper_idx, hyper in enumerate(HYPERS):
                                    ...
                                    result_dir = get_result_dir(shots, image, text, EVAL_MODE, view, cross_modal, architecture, logit, hyper)
                                    all_dataset_finished = True
                                    all_dataset_dict = {}
                                    for dataset_idx, dataset in enumerate(DATASETS):
                                        print(f"Dataset: {dataset} | {dataset_idx + 1}/{len(DATASETS)}")
                                        template = template_map_dict[dataset]
