...
from new_logit_ablation import get_hyperparams_str, get_save_dir, get_valid_batch_sizes, validate
...
if EVAL_MODE == 'partial':
    #### Partial START
    EVAL_DIR = "./new_logit_ablation_results_partial"
    ...
    EVAL_DIR = "./new_logit_ablation_results_linear"
    ## first layer
    IMAGES = ["rn50_layer_0"]
