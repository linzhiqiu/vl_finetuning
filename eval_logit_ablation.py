...
from logit_ablation import get_hyperparams_str, get_save_dir, get_valid_batch_sizes, validate


# EVAL_MODE = 'partial'
# EVAL_MODE = 'linear'
EVAL_MODE = 'fixed_logit_redo'
if EVAL_MODE == 'partial':
    ...
    #### Partial END
elif EVAL_MODE == 'fixed_logit_redo':
    EVAL_DIR = "./temp"
    ## first layer
    IMAGES = ["rn50_layer_0"]
    ...
    EVAL_DIR = "./linear_logit_ablation_results"
    ## first layer
    IMAGES = ["rn50_layer_0"]
...
def setup_cfg(dataset,
    ...
    cfg.merge_from_file(f"config/new_logit/{logit}.yaml")
                                                    ...
                                                    for wd in cfg.OPTIM.WEIGHT_DECAY:
                                                        ...
                                                        for batch_size in VALID_BATCH_SIZES:
                                                            ...
                                                            for iters in cfg.OPTIM.MAX_ITER:
                                                                ...
                                                                if not EVAL_MODE == 'fixed_logit_redo' and not os.path.exists(best_val_path) or not os.path.exists(last_iter_path):
