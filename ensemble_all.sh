#!/bin/bash
# Logit scale 4
# Running on trinity-2-9 for imagenet
# Running on trinity-0-23 for 10 datasets
# logit scale default
# Running on trinity-2-5 for 11 datasets , then out of storage, so moving to /data3
WORKERS=0
